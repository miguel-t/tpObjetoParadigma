...
object testSimFixture {
	...
	method getTrabajoMercenarioSocial() = new Trabajo("programador", mercenarioSocial, 20000)
	method getTrabajoAburridoHastaLaMuerte() = new Trabajo("data entry", aburridoHastaLaMuerte, 15000)
